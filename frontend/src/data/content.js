...
export const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Kubideh 2x", desc: "Hackfleischspieße aus Lamm und Rind mit Reis oder Pommes", allergens: [], price: "€ 17,90" },
      { name: "Kabab-e Morgh", desc: "Hühnerspieße 2x mit Reis oder Pommes", allergens: [], price: "€ 16,90" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Cream Roll 2x", desc: "Teigröllchen mit süßer Sahnefüllung", allergens: ["A", "C", "G"], price: "€ 4,90" },
      { name: "Jelabi 2x", desc: "", allergens: ["A"], price: "€ 4,90" },
